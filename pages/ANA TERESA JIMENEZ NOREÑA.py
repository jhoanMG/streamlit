...
st.set_page_config(page_title="Análisis de Siembras - ANA TERESA JIMENEZ NOREÑA", layout="wide")
...
st.markdown("<h1 style='text-align: center; color: #4A90E2;'>RENDIMIENTO SEMBRADORES - ANA TERESA JIMENEZ NOREÑA</h1>", unsafe_allow_html=True)

selected_sembradores = st.sidebar.multiselect('Selecciona Sembradores', ['ANA TERESA JIMENEZ NOREÑA'])
