...
st.set_page_config(page_title="Análisis de Siembras - CLARA DANY SANDOVAL RIVERA", layout="wide")
...
st.markdown("<h1 style='text-align: center; color: #4A90E2;'>RENDIMIENTO SEMBRADORES - CLARA DANY SANDOVAL RIVERA</h1>", unsafe_allow_html=True)

selected_sembradores = st.sidebar.multiselect('Selecciona Sembradores', ['CLARA DANY SANDOVAL RIVERA'])
