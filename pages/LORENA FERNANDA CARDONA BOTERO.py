...
st.set_page_config(page_title="Análisis de Siembras - LORENA FERNANDA CARDONA BOTERO", layout="wide")
...
st.markdown("<h1 style='text-align: center; color: #4A90E2;'>RENDIMIENTO SEMBRADORES - LORENA FERNANDA CARDONA BOTERO</h1>", unsafe_allow_html=True)

selected_sembradores = st.sidebar.multiselect('Selecciona Sembradores', ['LORENA FERNANDA CARDONA BOTERO'])
