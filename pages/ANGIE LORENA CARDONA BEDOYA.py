...
st.set_page_config(page_title="Análisis de Siembras - ANGIE LORENA CARDONA BEDOYA", layout="wide")
...
st.markdown("<h1 style='text-align: center; color: #4A90E2;'>RENDIMIENTO SEMBRADORES - ANGIE LORENA CARDONA BEDOYA</h1>", unsafe_allow_html=True)

selected_sembradores = st.sidebar.multiselect('Selecciona Sembradores', ['ANGIE LORENA CARDONA BEDOYA'])
