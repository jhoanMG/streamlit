...
st.set_page_config(page_title="Análisis de Siembras - LUZ ENAIDA ALZATE VILLADA", layout="wide")
...
st.markdown("<h1 style='text-align: center; color: #4A90E2;'>RENDIMIENTO SEMBRADORES - LUZ ENAIDA ALZATE VILLADA</h1>", unsafe_allow_html=True)

selected_sembradores = st.sidebar.multiselect('Selecciona Sembradores', ['LUZ ENAIDA ALZATE VILLADA'])
