...
st.set_page_config(page_title="Análisis de Siembras - MAYRA ISABEL HURTADO MARTINEZ", layout="wide")
...
st.markdown("<h1 style='text-align: center; color: #4A90E2;'>RENDIMIENTO SEMBRADORES - MAYRA ISABEL HURTADO MARTINEZ</h1>", unsafe_allow_html=True)

selected_sembradores = st.sidebar.multiselect('Selecciona Sembradores', ['MAYRA ISABEL HURTADO MARTINEZ'])
