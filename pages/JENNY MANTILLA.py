...
st.set_page_config(page_title="Análisis de Siembras - JENNY MANTILLA", layout="wide")
...
st.markdown("<h1 style='text-align: center; color: #4A90E2;'>RENDIMIENTO SEMBRADORES - JENNY MANTILLA</h1>", unsafe_allow_html=True)

selected_sembradores = st.sidebar.multiselect('Selecciona Sembradores', ['JENNY MANTILLA'])
