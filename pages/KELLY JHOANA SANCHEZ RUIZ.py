...
st.set_page_config(page_title="Análisis de Siembras - KELLY JHOANA SANCHEZ RUIZ", layout="wide")
...
st.markdown("<h1 style='text-align: center; color: #4A90E2;'>RENDIMIENTO SEMBRADORES - KELLY JHOANA SANCHEZ RUIZ</h1>", unsafe_allow_html=True)

selected_sembradores = st.sidebar.multiselect('Selecciona Sembradores', ['KELLY JHOANA SANCHEZ RUIZ'])
