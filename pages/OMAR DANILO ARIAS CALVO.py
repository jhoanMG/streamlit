...
st.set_page_config(page_title="Análisis de Siembras - OMAR DANILO ARIAS CALVO", layout="wide")
...
st.markdown("<h1 style='text-align: center; color: #4A90E2;'>RENDIMIENTO SEMBRADORES - OMAR DANILO ARIAS CALVO</h1>", unsafe_allow_html=True)

selected_sembradores = st.sidebar.multiselect('Selecciona Sembradores', ['OMAR DANILO ARIAS CALVO'])
